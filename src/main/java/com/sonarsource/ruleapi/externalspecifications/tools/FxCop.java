...
public class FxCop extends AbstractReportableExternalTool {
  ...
  public enum FxCopRule implements CodingStandardRule {
    ...
    DELEGATESMUSTBINDWITHCONSISTENTTRANSPARENCY("DelegatesMustBindWithConsistentTransparency", Implementability.REJECTED),
    ...
    DONOTINDIRECTLYEXPOSEMETHODSWITHLINKDEMANDS("DoNotIndirectlyExposeMethodsWithLinkDemands", Implementability.REJECTED),
    ...
    DONOTTREATFIBERSASTHREADS("DoNotTreatFibersAsThreads", Implementability.REJECTED),
    ...
    MEMBERSSHOULDDIFFERBYMORETHANRETURNTYPE("MembersShouldDifferByMoreThanReturnType", Implementability.REJECTED),
    ...
    METHODSMUSTOVERRIDEWITHCONSISTENTTRANSPARENCY("MethodsMustOverrideWithConsistentTransparency", Implementability.REJECTED),
    ...
    OVERRIDELINKDEMANDSSHOULDBEIDENTICALTOBASE("OverrideLinkDemandsShouldBeIdenticalToBase", Implementability.REJECTED),
    ...
    SECURITYRULESETLEVEL2METHODSSHOULDNOTBEPROTECTEDWITHLINKDEMANDS("SecurityRuleSetLevel2MethodsShouldNotBeProtectedWithLinkDemands", Implementability.REJECTED),
    SECURITYTRANSPARENTCODESHOULDNOTASSERT("SecurityTransparentCodeShouldNotAssert", Implementability.REJECTED),
    ...
    STATICCONSTRUCTORSSHOULDBEPRIVATE("StaticConstructorsShouldBePrivate", Implementability.REJECTED),
    ...
    TRANSPARENTMETHODSMUSTBEVERIFIABLE("TransparentMethodsMustBeVerifiable", Implementability.REJECTED),
    TRANSPARENTMETHODSMUSTNOTCALLNATIVECODE("TransparentMethodsMustNotCallNativeCode", Implementability.REJECTED),
    TRANSPARENTMETHODSMUSTNOTCALLSUPPRESSUNMANAGEDCODESECURITYMETHODS("TransparentMethodsMustNotCallSuppressUnmanagedCodeSecurityMethods", Implementability.REJECTED),
    TRANSPARENTMETHODSMUSTNOTHANDLEPROCESSCORRUPTINGEXCEPTIONS("TransparentMethodsMustNotHandleProcessCorruptingExceptions", Implementability.REJECTED),
    TRANSPARENTMETHODSMUSTNOTREFERENCECRITICALCODE("TransparentMethodsMustNotReferenceCriticalCode", Implementability.REJECTED),
    TRANSPARENTMETHODSMUSTNOTSATISFYLINKDEMANDS("TransparentMethodsMustNotSatisfyLinkDemands", Implementability.REJECTED),
    TRANSPARENTMETHODSSHOULDNOTBEPROTECTEDWITHLINKDEMANDS("TransparentMethodsShouldNotBeProtectedWithLinkDemands", Implementability.REJECTED),
    TRANSPARENTMETHODSSHOULDNOTDEMAND("TransparentMethodsShouldNotDemand", Implementability.REJECTED),
    TRANSPARENTMETHODSSHOULDNOTLOADASSEMBLIESFROMBYTEARRAYS("TransparentMethodsShouldNotLoadAssembliesFromByteArrays", Implementability.REJECTED),
    TRANSPARENTMETHODSSHOULDNOTUSESUPPRESSUNMANAGEDCODESECURITY("TransparentMethodsShouldNotUseSuppressUnmanagedCodeSecurity", Implementability.REJECTED),
    ...
    TYPESMUSTBEATLEASTASCRITICALASBASETYPES("TypesMustBeAtLeastAsCriticalAsBaseTypes", Implementability.REJECTED),
    ...
    WRAPVULNERABLEFINALLYCLAUSESINOUTERTRY("WrapVulnerableFinallyClausesInOuterTry", Implementability.REJECTED);
