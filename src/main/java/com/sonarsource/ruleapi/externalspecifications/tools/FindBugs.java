...
public class FindBugs extends AbstractReportableExternalTool {
  ...
  public enum StandardRule implements CodingStandardRule {
    ...
    HSC_HUGE_SHARED_STRING_CONSTANT(Implementability.REJECTED),
    ...
    IP_PARAMETER_IS_DEAD_BUT_OVERWRITTEN(Implementability.REJECTED),
    IS_FIELD_NOT_GUARDED(Implementability.REJECTED),
    IS_INCONSISTENT_SYNC(Implementability.REJECTED),
    IS2_INCONSISTENT_SYNC(Implementability.REJECTED),
    ...
    JCIP_FIELD_ISNT_FINAL_IN_IMMUTABLE_CLASS(Implementability.REJECTED),
    ...
    LG_LOST_LOGGER_DUE_TO_WEAK_REFERENCE(Implementability.REJECTED),
    ...
    SI_INSTANCE_BEFORE_FINALS_ASSIGNED(Implementability.REJECTED),
    ...
    SP_SPIN_ON_FIELD(Implementability.REJECTED),
    ...
    TQ_ALWAYS_VALUE_USED_WHERE_NEVER_REQUIRED(Implementability.REJECTED),
    TQ_COMPARING_VALUES_WITH_INCOMPATIBLE_TYPE_QUALIFIERS(Implementability.REJECTED),
    TQ_EXPLICIT_UNKNOWN_SOURCE_VALUE_REACHES_ALWAYS_SINK(Implementability.REJECTED),
    TQ_EXPLICIT_UNKNOWN_SOURCE_VALUE_REACHES_NEVER_SINK(Implementability.REJECTED),
    TQ_MAYBE_SOURCE_VALUE_REACHES_ALWAYS_SINK(Implementability.REJECTED),
    TQ_MAYBE_SOURCE_VALUE_REACHES_NEVER_SINK(Implementability.REJECTED),
    TQ_NEVER_VALUE_USED_WHERE_ALWAYS_REQUIRED(Implementability.REJECTED),
    TQ_UNKNOWN_VALUE_USED_WHERE_ALWAYS_STRICTLY_REQUIRED(Implementability.REJECTED),
    ...
    UMAC_UNCALLABLE_METHOD_OF_ANONYMOUS_CLASS(Implementability.REJECTED),
    UOE_USE_OBJECT_EQUALS(Implementability.REJECTED),
    ...
    VA_PRIMITIVE_ARRAY_PASSED_TO_OBJECT_VARARG(Implementability.REJECTED),
    ...
    BSHIFT_WRONG_ADD_PRIORITY(Implementability.IMPLEMENTABLE),
    CO_COMPARETO_INCORRECT_FLOATING(Implementability.IMPLEMENTABLE),
    DC_PARTIALLY_CONSTRUCTED(Implementability.IMPLEMENTABLE),
    DM_BOXED_PRIMITIVE_FOR_COMPARE(Implementability.IMPLEMENTABLE),
    DM_INVALID_MIN_MAX(Implementability.IMPLEMENTABLE),
    ME_MUTABLE_ENUM_FIELD(Implementability.IMPLEMENTABLE),
    ME_ENUM_FIELD_SETTER(Implementability.IMPLEMENTABLE),
    MS_MUTABLE_COLLECTION(Implementability.IMPLEMENTABLE),
    MS_MUTABLE_COLLECTION_PKGPROTECT(Implementability.IMPLEMENTABLE),
    RANGE_ARRAY_INDEX(Implementability.IMPLEMENTABLE),
    RANGE_ARRAY_OFFSET(Implementability.IMPLEMENTABLE),
    RANGE_ARRAY_LENGTH(Implementability.IMPLEMENTABLE),
    RANGE_STRING_INDEX(Implementability.IMPLEMENTABLE),
    RV_RETURN_VALUE_IGNORED_NO_SIDE_EFFECT(Implementability.IMPLEMENTABLE),
    UC_USELESS_CONDITION(Implementability.IMPLEMENTABLE),
    UC_USELESS_CONDITION_TYPE(Implementability.IMPLEMENTABLE),
    UC_USELESS_OBJECT(Implementability.IMPLEMENTABLE),
    UC_USELESS_OBJECT_STACK(Implementability.IMPLEMENTABLE),
    UC_USELESS_VOID_METHOD(Implementability.IMPLEMENTABLE);
