...
public class Pylint extends AbstractReportableExternalTool {
  ...
  public enum PylintRule implements CodingStandardRule {
    ...
    C0322 ("Old: Operator not preceded by a space", Implementability.IMPLEMENTABLE),
    C0323 ("Old: Operator not followed by a space", Implementability.IMPLEMENTABLE),
    C0324 ("Old: Comma not followed by a space", Implementability.IMPLEMENTABLE),
    C0325 ("Unnecessary parens after %r keyword", Implementability.IMPLEMENTABLE),
    C0326 ("%s space %s %s %s\n%s", Implementability.IMPLEMENTABLE),
    ...
    E0011 ("Unrecognized file option %r", Implementability.IMPLEMENTABLE),
    E0012 ("Bad option value %r", Implementability.IMPLEMENTABLE),
    ...
    E0501 ("Old: Non ascii characters found but no encoding specified (PEP 263)", Implementability.IMPLEMENTABLE),
    E0502 ("Old: Wrong encoding specified (%s)", Implementability.IMPLEMENTABLE),
    E0503 ("Old: Unknown encoding specified (%s)", Implementability.IMPLEMENTABLE),
    ...
    E1122 ("Old: Duplicate keyword argument %r in function call", Implementability.IMPLEMENTABLE),
    ...
    E1125 ("Old: Missing mandatory keyword argument %r", Implementability.IMPLEMENTABLE),
    ...
    F0001 ("(error prevented analysis; message varies)", Implementability.IMPLEMENTABLE),
    F0002 ("%s: %s (message varies)", Implementability.IMPLEMENTABLE),
    F0003 ("ignored builtin module %s", Implementability.IMPLEMENTABLE),
    F0004 ("unexpected inferred value %s", Implementability.IMPLEMENTABLE),
    F0010 ("error while code parsing: %s", Implementability.IMPLEMENTABLE),
    F0202 ("Unable to check methods signature (%s / %s)", Implementability.IMPLEMENTABLE),
    F0220 ("failed to resolve interfaces implemented by %s (%s)", Implementability.IMPLEMENTABLE),
    F0321 ("Old: Format detection error in %r", Implementability.IMPLEMENTABLE),
    F0401 ("Unable to import %s", Implementability.IMPLEMENTABLE),
    I0001 ("Unable to run raw checkers on built-in module %s", Implementability.IMPLEMENTABLE),
    I0010 ("Unable to consider inline option %r", Implementability.IMPLEMENTABLE),
    I0011 ("Locally disabling %s", Implementability.IMPLEMENTABLE),
    I0012 ("Locally enabling %s", Implementability.IMPLEMENTABLE),
    I0013 ("Ignoring entire file", Implementability.IMPLEMENTABLE),
    I0014 ("Used deprecated directive \"pylint:disable-all\" or \"pylint:disable=all\"", Implementability.IMPLEMENTABLE),
    I0020 ("Suppressed %s (from line %d)", Implementability.IMPLEMENTABLE),
    I0021 ("Useless suppression of %s", Implementability.IMPLEMENTABLE),
    I0022 ("Deprecated pragma \"pylint:disable-msg\" or \"pylint:enable-msg\"", Implementability.IMPLEMENTABLE),
