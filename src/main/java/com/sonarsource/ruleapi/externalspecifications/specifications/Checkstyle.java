...
public class Checkstyle extends AbstractReportableExternalTool {
  ...
  public enum CheckstyleRule implements CodingStandardRule {
    ...
    AVOIDSTATICIMPORT("AvoidStaticImport", Implementability.IMPLEMENTABLE),
    ...
    EXECUTABLESTATEMENTCOUNT("ExecutableStatementCount", Implementability.IMPLEMENTABLE),
    ...
    INNERTYPELAST("InnerTypeLast", Implementability.IMPLEMENTABLE),
    ...
    JAVADOCVARIABLE("JavadocVariable", Implementability.IMPLEMENTABLE),
    ...
    OUTERTYPEFILENAME("OuterTypeFileName", Implementability.IMPLEMENTABLE),
    ...
    PACKAGEANNOTATION("PackageAnnotation", Implementability.IMPLEMENTABLE),
    ...
    REQUIRETHIS("RequireThis", Implementability.IMPLEMENTABLE),
    ...
    UNIQUEPROPERTIES("UniqueProperties", Implementability.IMPLEMENTABLE),
