...
public class Pmd extends AbstractReportableExternalTool {
  ...
  public enum ToolRule implements CodingStandardRule {
    ...
    AVOIDFINALLOCALVARIABLE("AvoidFinalLocalVariable", Implementability.IMPLEMENTABLE),
    ...
    AVOIDUSINGVOLATILE("AvoidUsingVolatile", Implementability.IMPLEMENTABLE),
    ...
    BIGINTEGERINSTANTIATION("BigIntegerInstantiation", Implementability.IMPLEMENTABLE),
    ...
    BOOLEANINVERSION("BooleanInversion", Implementability.IMPLEMENTABLE),
    ...
    CONFUSINGTERNARY("ConfusingTernary", Implementability.IMPLEMENTABLE),
    CONSECUTIVEAPPENDSSHOULDREUSE("ConsecutiveAppendsShouldReuse", Implementability.IMPLEMENTABLE),
    ...
    DATAFLOWANOMALYANALYSIS("DataflowAnomalyAnalysis", Implementability.IMPLEMENTABLE),
    ...
    EMPTYMETHODINABSTRACTCLASSSHOULDBEABSTRACT("EmptyMethodInAbstractClassShouldBeAbstract", Implementability.IMPLEMENTABLE),
    ...
    GODCLASS("GodClass", Implementability.IMPLEMENTABLE),
    GUARDDEBUGLOGGING("GuardDebugLogging", Implementability.IMPLEMENTABLE),
    GUARDLOGSTATEMENT("GuardLogStatement", Implementability.IMPLEMENTABLE),
    GUARDLOGSTATEMENTJAVAUTIL("GuardLogStatementJavaUtil", Implementability.IMPLEMENTABLE),
    ...
    INEFFICIENTEMPTYSTRINGCHECK("InefficientEmptyStringCheck", Implementability.IMPLEMENTABLE),
    ...
    INSUFFICIENTSTRINGBUFFERDECLARATION("InsufficientStringBufferDeclaration", Implementability.IMPLEMENTABLE),
    ...
    LAWOFDEMETER("LawOfDemeter", Implementability.IMPLEMENTABLE),
    LOCALHOMENAMINGCONVENTION("LocalHomeNamingConvention", Implementability.IMPLEMENTABLE),
    LOCALINTERFACESESSIONNAMINGCONVENTION("LocalInterfaceSessionNamingConvention", Implementability.IMPLEMENTABLE),
    LOCALVARIABLECOULDBEFINAL("LocalVariableCouldBeFinal", Implementability.IMPLEMENTABLE),
    ...
    MDBANDSESSIONBEANNAMINGCONVENTION("MDBAndSessionBeanNamingConvention", Implementability.IMPLEMENTABLE),
    ...
    NULLASSIGNMENT("NullAssignment", Implementability.IMPLEMENTABLE),
    ...
    REDUNDANTFIELDINITIALIZER("RedundantFieldInitializer", Implementability.IMPLEMENTABLE),
    REMOTEINTERFACENAMINGCONVENTION("RemoteInterfaceNamingConvention", Implementability.IMPLEMENTABLE),
    REMOTESESSIONINTERFACENAMINGCONVENTION("RemoteSessionInterfaceNamingConvention", Implementability.IMPLEMENTABLE),
    ...
    SIMPLEDATEFORMATNEEDSLOCALE("SimpleDateFormatNeedsLocale", Implementability.IMPLEMENTABLE),
    ...
    USECONCURRENTHASHMAP("UseConcurrentHashMap", Implementability.IMPLEMENTABLE),
    ...
    USESTRINGBUFFERFORSTRINGAPPENDS("UseStringBufferForStringAppends", Implementability.IMPLEMENTABLE),
    ...
    USEVARARGS("UseVarargs", Implementability.IMPLEMENTABLE),
