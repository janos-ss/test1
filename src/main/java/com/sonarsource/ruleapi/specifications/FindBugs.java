...
public enum FindBugs {
  ...
  BAC_BAD_APPLET_CONSTRUCTOR ( Implementability.IMPLEMENTABLE ),
  BC_BAD_CAST_TO_ABSTRACT_COLLECTION ( Implementability.IMPLEMENTABLE ),
  BC_BAD_CAST_TO_CONCRETE_COLLECTION ( Implementability.IMPLEMENTABLE ),
  ...
  IMA_INEFFICIENT_MEMBER_ACCESS ( Implementability.IMPLEMENTABLE ),
  ...
  FindBugs(Implementability ability) {
